...
7. [Локальный тест на одном машине](#локальный-тест-на-одном-машине)
...
```
┌─────────────────────────────┐     ┌──────────────────┐     ┌──────────────────┐
│        MASTER (машина 1)      │     │  WORKER1 (машина 2)│     │  WORKER2 (машина 3)│
│                             │     │                  │     │                  │
│  ┌─────────┐ ┌────────────┐ │     │  ┌──────────┐   │     │  ┌──────────┐   │
...
| Диск | ≥ 10 ГБ | ≥ 5 ГБ |
| Сеть | Все 3 машины в одной LAN, `ping IP_другой_машины` проходит | — |
...
2. Пересоберите контейнеры на всех машинах, чтобы подтянулись актуальные конфиги: `stop.bat` и `start.bat`.
